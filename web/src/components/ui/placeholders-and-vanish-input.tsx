...
export function PlaceholdersAndVanishInput({
  ...
  }, [startAnimation, handleVisibilityChange, stopAnimation])
  ...
  return (
    <form
      className={cn(
        "w-full relative max-w-3xl mx-auto h-14 rounded-2xl overflow-hidden",
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none text-white bg-transparent h-full rounded-2xl focus:outline-none focus:ring-0 pl-4 sm:pl-12 pr-16",
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-9 w-9 rounded-xl disabled:bg-zinc-800 bg-blue-600 disabled:text-zinc-400 text-white hover:bg-blue-700 transition duration-200 flex items-center justify-center border border-zinc-700/50"
      >
        <motion.svg
